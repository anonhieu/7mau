...
function textcolorizer_handle() {
    ...
    if (input_strike != document.getElementById("input_strike").checked) { update = 1; }
    input_strike = document.getElementById("input_strike").checked;

    if (input_s != document.getElementById("input_s").checked) { update = 1; }
    input_s = document.getElementById("input_s").checked;
    ...
    if (update == 1) {
        ...
        if (input_effect == "1") {
            ...
            for (a = 0; a < input_text.length; a++) {
                ...
                if (input_text.charAt(a) == " ") {
                    ...
                    str_bbcode += '[' + ccol + ']' + input_text.charAt(a);
                }
                r += rinc;
                g += ginc;
                b += binc;
        ...
        document.getElementById("div_preview").innerHTML = "<span style='font-size:26px';>" + str_html + "</span>";
